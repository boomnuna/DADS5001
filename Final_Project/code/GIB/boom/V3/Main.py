...
st.markdown('<div class="hero-sub">วิเคราะห์หุ้นด้วย Technical Analysis, Machine Learning และ AI<br>เพื่อช่วยนักลงทุนตัดสินใจได้อย่างมั่นใจขึ้น</div>', unsafe_allow_html=True)
...
<div class="disclaimer-banner">
  ...
  <div style="color:#fcd34d;font-size:0.85rem;line-height:1.7;">
    ...
    ข้อมูลและการวิเคราะห์ทั้งหมดมีไว้เพื่อ <strong>ประกอบการศึกษา</strong> เท่านั้น<br>
...
stack = {
    ...
    "🌲 Random Forest": "Pattern Recognition จากข้อมูลย้อนหลัง",
}
cols = st.columns(4)
